...
WSDL.prototype.xmlToObject = function(xml) {
  ...
  p.onopentag = function(node) {
    ...
    // schema may be defined only in the top schema/name, but not be accessible via
    // topSchema[name]. note that this could also be a bug in topSchema setup. 
    var childSchemaObject = self.findChildSchemaObject(topSchema, name);
